package com.lotuas.common.scan.util;
...
//        System.out.println(findPackageClass("com.lotuas").size());


//        Enumeration resourceUrls = ClassLoader.getSystemClassLoader().getResources("com.lotuas");
